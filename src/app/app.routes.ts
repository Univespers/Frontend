...
import { ColleaguesComponent } from './pages/colleagues/colleagues.component';
...
import { studentAccessGuard } from './pages/student-access.guard';
import { guestAccessGuard } from './pages/guest-access.guard';
